...
images = {
    ...
    'Field (Cotton)': r'c:\Users\ABHIRAM MODUKURU\OneDrive\Desktop\AgriVision-AI\backend\data\processed_field_dataset\cotton_healthy\cottondisease_d (1)_iaip.jpg'
}
